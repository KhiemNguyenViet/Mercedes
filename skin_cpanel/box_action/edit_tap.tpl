    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Chỉnh sửa tập <span class="color_green">"{ten_phim}"</span></h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_100">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="link_copy" value="" placeholder="Nhập link copy truyện...">
                </div>
                <div class="form_group">
                    <button class="button_all" name="copy_chap"> Copy tập </button>
                </div>
                <div class="form_group">
                    <label for="">Tên tập</label>
                    <input type="text" class="form_control" name="tieu_de" value="{tieu_de}" placeholder="Nhập tên chap...">
                </div>
            </div>
            ...
            <div style="clear: both;"></div>
            <div class="form_group">
                <button class="button_all" name="edit_tap"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
