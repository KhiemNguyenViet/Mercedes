        ...
        <div class="box_profile">
            ...
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="username" value="{user_id}" disabled="disabled" placeholder="Nhập ID Tài khoản...">
                </div>
                <div class="form_group" id="input_link">
                    <label for="">Coin hiện có</label>
                    <input type="text" class="form_control" name="user_money" value="{user_money}" disabled="disabled" placeholder="Số coin hiện có...">
                </div>              
                <div class="form_group">
            ...
            <div class="form_group">
                ...
                <button name="add_coin" class="button_all"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>
