    ...
    <div class="box_right_content">
        <div class="box_profile">
            <div class="page_title">
                <h1 class="undefined">Thêm gói premium mới</h1>
                <div class="line"></div>
                <hr>
            </div>
            <div class="col_50">
                <div class="form_group">
                    ...
                    <input type="text" class="form_control" name="tieu_de" value="" placeholder="Nhập tên gói...">
                </div>
                <div class="form_group">
                    <label for="">Số ngày premium</label>
                    <input type="text" class="form_control" name="expired" value="" placeholder="Nhập số ngày premium...">
                </div>
                <div class="form_group">
                    <label for="">Giá gói</label>
                    <input type="text" class="form_control" name="price" value="" placeholder="Nhập giá gói premium...">
                </div>
            </div>
            <div style="clear: both;"></div>
            <div class="form_group">
                <button class="button_all" name="add_premium"> Hoàn thành </button>
            </div>
        </div>
    </div>
</div>