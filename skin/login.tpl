            ...
            <div class="login-page">
                ...
                <div class="ah-form flex flex-column flex-hozi-center ah-frame-bg">
                    ...
                    <div class="box_form">
                        <div>
                            <label>Email</label>
                            <input type="email" placeholder="Nhập email/username của bạn" value="" name="username">
                        </div>
                        <div>
                        ...
                        <div class="flex flex-hozi-center flex-column">
                            <div class="flex flex-hozi-center">
                                <button type="button" class="button-default color-white bg-red" name="action_login" id="button_login">Đăng nhập</button>
                                <b style="padding: 10px;">Hoặc</b>
                                <a href="/dang-ky.html" class="button-default bg-green margin-5-0 padding-10-20">Đăng ký</a>
                            </div>
                        </div>
                    </div>
                </div>
