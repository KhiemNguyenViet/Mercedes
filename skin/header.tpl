...
<head>
    ...
    <link href="/skin/css/styles.css?t=<?php echo time();?>" rel="stylesheet" />
    <link href="/skin/css/dark.css" rel="stylesheet">
    ...
    })(navigator.userAgent || navigator.vendor || window.opera, '//phimhh.net//');
    </script>
    <style>
        body {
            background: url(/skin/css/images/bg.jpeg) fixed center;
        }
    </style>
</head>