            ...
            <div class="login-page">
                <div class="margin-10-0 bg-black2 flex flex-space-auto">
                    <div class="fs-17 fw-700 padding-0-20 color-gray inline-flex height-40 flex-hozi-center bg-black border-l-t">
                        <h3 class="section-title"><span>Đổi mật khẩu mới</span></h3>
                    </div>
                </div>
                <div class="ah-form flex flex-column flex-hozi-center ah-frame-bg">
                    <div class="box_form">
                        <div>
                            ...
                            <input type="password" placeholder="Nhập mật khẩu hiện tại" name="password_old">
                        </div>
                        <div>
                            <label>Mật khẩu</label>
                            <input type="password" placeholder="Nhập mật khẩu của bạn" name="password_new">
                        </div>
                        <div>
                            <label>Nhập Lại Mật khẩu</label>
                            <input type="password" placeholder="Nhập Lại mật khẩu của bạn" name="re_password_new">
                        </div>
                        <div id="message-line"> </div>
                        <div class="flex flex-hozi-center flex-column">
                            <div class="flex flex-hozi-center">
                                <button type="button" class="button-default color-white bg-red" name="button_password"><span class="material-icons-round margin-0-5">save</span>Lưu thay đổi</button>
                            </div>
                        </div>
                    </div>
                </div>
